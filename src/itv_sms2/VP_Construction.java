 ...
 */
public class VP_Construction 
{
     
    public static void VP_ConstructionPressed(BorderPane pane, GridPane forms) throws FileNotFoundException
    {
        
        /**checks to see if the path and the CSV file VP_Construction exist.  If not,
         * this class makes it. */
        MakeVP_Construction.MakingVP_Construction();
        
        //initializing path for VP_Details.csv
        File VPConstruction = new File
        ("src/StoredINFO/VesselParticulars/VP_Construction.csv");
        ...
        Label ConstructionInfo = new Label("   Construction Information:  ");
        ConstructionInfo.setStyle("-fx-font-weight: bold");
        Label builder = new Label("   Builder:");
        Label constructionLocation = new Label("   Construction Location:");
        ...
        TextField tfConstructionLocation = new TextField();
        ...
        {
            Logger.getLogger(VP_Construction.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        hbox99.getChildren().add(btSave);
        
                
        //****************Reading from VP_Construction CSV************************
        
         //creating an array from VPConstruction seperating each string by commas
        line = "";
        cvsSplitBy = ",";
        rows = new ArrayList<>();
        
        fileReader = new FileReader(VPConstruction);
        ...
        else
        {
            ...
            tfConstructionLocation.setText(lastRow[2]);
        ...
        btSave.setOnAction(e -> 
        {
            ...
            try {
                ...
                fileWriter = new FileWriter(VPConstruction, true);
                BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
                //writes to the CSV file
                bufferedWriter.write(timestamp.toString() + "," 
                        + tfBuilder.getText() + "," + tfConstructionLocation.getText() 
