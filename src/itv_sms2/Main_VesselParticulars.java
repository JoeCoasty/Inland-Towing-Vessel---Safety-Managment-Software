...
public class Main_VesselParticulars{
    
    public static void Main_VesselParticularsPressed(BorderPane pane) {
       ...
       pane.setTop(title); //adds HBox to top pane of borderPane
        ...
        Button details = new Button ("Vessel Details/Involved Parties");
        Button surveys = new Button ("Inspection/Survey/Audit Dates");
        Button specifics = new Button ("Vessel Specifics");
        Button propulsion = new Button("Propulsion");
        Button generator = new Button("Generator");
        Button steering = new Button("Steering/Maneuvering System");
        Button thrust = new Button("Thrusters");
        Button tanks = new Button("Tank Info");
        Button pressureVessels = new Button("Pressure Vessels");
        Button boiler = new Button("Boilers");
        Button construction = new Button ("Construction");
        Button routes = new Button("Vessel Routes");
        Button fireFighting = new Button("Fire Fighting");
        Button lifeSaving = new Button("Life Saving");
        ...
        details.setOnAction(e -> 
        {
           ...
           {
               Logger.getLogger(Main_VesselParticulars.class.getName()).log(Level.SEVERE, null, ex);
           }
        ...
        steering.setOnAction(e -> 
        {
           ...
           try 
           {
               VP_Steering.VP_SteeringPressed(pane, forms);
           } 
           catch (FileNotFoundException ex) 
           {
               Logger.getLogger(Main_VesselParticulars.class.getName()).log(Level.SEVERE, null, ex);
        ...
        routes.setOnAction(e -> 
        {
           ...
           try 
           {
               VP_Routes.VP_RoutesPressed(pane, forms);
           } 
           catch (FileNotFoundException ex) 
           {
               Logger.getLogger(Main_VesselParticulars.class.getName()).log(Level.SEVERE, null, ex);
        ...
        fireFighting.setOnAction(e -> 
        {
           ...
           try 
           {
               VP_FireFighting.VP_FireFightingPressed(pane, forms);
           } 
           catch (FileNotFoundException ex) 
           {
               Logger.getLogger(Main_VesselParticulars.class.getName()).log(Level.SEVERE, null, ex);
